...
public class DataService {
    ...
    public Optional<Version> getExternalData() {
        log.info("Get external frontend data called");
        final RestTemplate restTemplate = new RestTemplate();
        final String url = String.format("http://%s:%s/version", serverConfig.getServerFrontendAddress(), serverConfig.getServerFrontendPort());
        try {
